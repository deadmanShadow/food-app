    ...
    <div>
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        ...
        <nav>
          ...
          <a className="link link-hover">36/A, Banani Circuler Road, Dhaka-Bangladesh, 1280</a>
          <a className="link link-hover">foodieBD@yahoo.com</a>
          <a className="link link-hover">+029337633</a>
        </nav>
      </footer>
        <hr />
